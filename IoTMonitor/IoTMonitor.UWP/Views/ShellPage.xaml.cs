...
namespace IoTMonitor.UWP.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<GatewaysPage>("Shell_Gateways".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<TriggersPage>("Shell_Triggers".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<ActionsPage>("Shell_Actions".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<AnalyticsPage>("Shell_Analytics".GetLocalized(), Symbol.Document));
            _secondaryItems.Add(ShellNavigationItem.FromType<SettingsPage>("Shell_Settings".GetLocalized(), Symbol.Setting));
            _primaryItems.Add(ShellNavigationItem.FromType<DashboardsPage>("Shell_Dashboards".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<StorePage>("Shell_Store".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<PlacesPage>("Shell_Places".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<ThingsPage>("Shell_Things".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<PeoplePage>("Shell_People".GetLocalized(), Symbol.Document));
        }
